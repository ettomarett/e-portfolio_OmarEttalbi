...
const navKeys = ['home', 'about', 'certifications', 'services', 'projects', 'publications', 'experience', 'languages', 'interests', 'contact'] as const
const navHrefs = ['hero', 'about', 'certifications-card', 'services', 'projects', 'publications', 'experience', 'languages', 'interests', 'contact']
