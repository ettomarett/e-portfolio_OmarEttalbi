export const curriculumUI = {
  en: {
    ...
    headerSubtitle: "Cycle d'Ingénieur d'État en Informatique — Filière Génie Logiciel & Systèmes d'Information. Full curriculum with professors and topic coverage.",
    duration: 'Duration',
    ...
    ensiasDescription: "Cycle d'Ingénieur d'État — 3 years, 5 semesters of coursework + 1 semester end-of-studies internship (PFE). Semesters S1–S2 are Tronc Commun, S3–S4 Approfondissement, S5 Spécialisation GL.",
...
export const semesterTranslations = {
  en: {
    ...
    s1: {
      ...
      modules: [
        { subs: [
          { name: 'Algorithmique', topics: 'Complexity analysis, sorting/searching algorithms, divide-and-conquer, dynamic programming, greedy algorithms' },
          { name: 'Structures de Données', topics: 'Linked lists, stacks, queues, trees, hash tables, graphs, heaps, advanced traversal algorithms' },
          { name: 'Programmation Procédurale', topics: 'C programming, procedural paradigm, memory management, pointers, file I/O' },
        ]},
        { subs: [
          { name: 'Architecture des Ordinateurs', topics: 'Von Neumann architecture, CPU design, instruction sets, pipelining, memory hierarchy, cache' },
          { name: 'Assembleur et Microprocesseur', topics: 'Assembly language (x86), registers, addressing modes, interrupt handling' },
        ]},
        { subs: [
          { name: 'Probabilités', topics: "Probability spaces, conditional probability, Bayes' theorem, random variables, distributions (binomial, Poisson, normal), expectation, variance" },
          { name: "Statistique Descriptive pour l'Ingénieur", topics: 'Central tendency, dispersion, frequency distributions, data visualization, correlation analysis' },
          { name: 'Simulation des Comportements Probabilistes', topics: 'Monte Carlo methods, random number generation, stochastic simulation, probabilistic modeling' },
        ]},
        { subs: [
          { name: 'Théorie des Graphes', topics: 'Graph representations, shortest paths (Dijkstra, Bellman-Ford), spanning trees, graph coloring, network flows' },
          { name: 'Programmation Linéaire', topics: 'Simplex method, duality, sensitivity analysis, integer programming' },
        ]},
        { subs: [
          { name: 'Éthique et Déontologie', topics: 'Professional ethics in IT, intellectual property, data privacy, responsible innovation' },
        ]},
        { subs: [
          { name: "Économie d'Entreprise & Introduction au Management", topics: 'Business economics, organizational management, strategic planning' },
          { name: 'Comptabilité Générale et Gestion Financière', topics: 'Accounting fundamentals, financial statements, cost analysis' },
        ]},
      ],
    },
    s2: {
      ...
      modules: [
        { subs: [
          { name: 'Bases de Données I', topics: 'Relational model, ER diagrams, functional dependencies, normalization (1NF–BCNF), SQL fundamentals' },
          { name: 'Bases de Données II', topics: 'Advanced SQL, query optimization, triggers, stored procedures, transaction management, concurrency control' },
        ]},
        { subs: [
          { name: 'Transmission de Données', topics: 'Physical/data link layers, encoding, error detection/correction, protocols' },
          { name: 'Réseaux Informatiques', topics: 'OSI/TCP-IP models, routing, switching, network architecture, network security basics' },
          { name: "Système d'Exploitation", topics: 'Process management, memory management, file systems, scheduling, concurrency, threads' },
        ]},
        { subs: [
          { name: 'Calculabilité & Complexité', topics: 'Turing machines, decidability, computational complexity classes (P, NP, NP-complete), reductions' },
          { name: 'Logique des Prédicats', topics: 'Propositional logic, first-order logic, quantifiers, formal proofs, logical inference, resolution' },
        ]},
        { subs: [
          { name: 'Programmation Orientée Objet', topics: 'OOP principles (encapsulation, inheritance, polymorphism), Java/Python, design patterns, SOLID principles' },
          { name: 'Développement Web', topics: 'HTML/CSS/JavaScript, frontend/backend fundamentals, HTTP, RESTful principles' },
          { name: 'Développement XML', topics: 'XML syntax, DTD, XML Schema (XSD), XSLT, XPath, structured data exchange, XML-based data integration' },
        ]},
        { subs: [
          { name: 'Management Science', topics: 'Management principles, organizational behavior, decision-making' },
          { name: 'Analyse des Coûts', topics: 'Cost analysis methods, cost-volume-profit analysis, budgeting' },
        ]},
      ],
    },
    s3: {
      ...
      modules: [
        { subs: [{ name: 'Génie Logiciel', topics: 'Software development lifecycle, requirements engineering, UML, software architecture, testing strategies, quality assurance' }]},
        { subs: [{ name: 'Méthodologie de Développement des SI', topics: 'IS development methodologies (Merise, UML-based), business process modeling, conceptual/logical/physical data modeling, enterprise data architecture' }]},
        { subs: [{ name: 'Modélisation Objet', topics: 'Advanced UML (class, sequence, activity, state diagrams), object modeling, design patterns, domain modeling' }]},
        { subs: [{ name: 'Structuration & Échange de Données', topics: 'XML/JSON standards, data serialization, schema validation, structured data interchange, web services data formats (SOAP, REST payloads)' }]},
        { subs: [{ name: 'Programmation Objet Avancée', topics: 'Generics, reflection, annotations, advanced design patterns, frameworks, multithreading' }]},
        { subs: [
          { name: 'Théorie des Langages', topics: 'Regular/context-free grammars, automata (DFA, NFA, PDA), Chomsky hierarchy' },
          { name: 'Compilation', topics: 'Lexical analysis, parsing (LL, LR), AST construction, semantic analysis, code generation' },
        ]},
        { subs: [{ name: 'Réseaux TCP/IP / Technologies de Routage', topics: 'TCP/IP stack, routing protocols (OSPF, BGP), subnetting, VLANs, network design' }]},
        { subs: [
          { name: 'Statistique Inférentielle', topics: 'Hypothesis testing, confidence intervals, parameter estimation, chi-squared tests, ANOVA, regression analysis' },
          { name: 'Analyse de Données', topics: 'Principal Component Analysis (PCA), clustering (k-means, hierarchical), classification, discriminant analysis, multivariate data visualization, data mining techniques' },
        ]},
        { subs: [
          ...
          { name: 'Virtualisation', topics: 'Hypervisors (Type 1/2), VMs, containers (Docker), resource management, orchestration' },
        ]},
        { subs: [{ name: 'Systèmes Distribués', topics: 'Distributed architectures, middleware, RPC/RMI, consistency models (CAP theorem), consensus algorithms, distributed databases' }]},
        { subs: [{ name: 'Administration UNIX', topics: 'Linux system administration, shell scripting (bash), process management, permissions, cron, system services' }]},
      ],
    },
    s4: {
      title: 'Semester 4 — Approfondissement',
      modules: [
        { subs: [{ name: "Fondement de l'IA / AI Technologies", topics: 'Designing AI solutions (design thinking, structured workflows), AI frameworks (TensorFlow, Keras, PyTorch, Apache Spark), supervised/unsupervised/reinforcement learning, neural networks, AutoAI & AI scaling (PyCaret, Spark MLlib), MLOps deployment & lifecycle (MLFlow, Azure ML, SageMaker), generative AI (RNNs, LSTMs, GRUs, Transformers, GANs), Large Language Models (GPT architecture, fine-tuning LLMs), prompt engineering (zero-shot, few-shot, chain-of-thought), AI ethics (fairness, explainability, privacy).' }]},
        { subs: [
          { name: 'Administration des Bases de Données I', topics: 'DBA fundamentals, Oracle/PostgreSQL administration, backup/recovery, user management, performance monitoring' },
          { name: 'Administration des Bases de Données II', topics: 'Advanced DBA, replication, partitioning, performance tuning, indexing strategies, database security' },
          { name: 'Bases de Données Réparties', topics: 'Distributed database architectures, data fragmentation, replication strategies, distributed query processing, two-phase commit, consistency in distributed data stores' },
        ]},
        { subs: [
          { name: 'Datawarehouse : Architectures et Applications', topics: 'Data warehouse architecture (Inmon, Kimball), star/snowflake schemas, ETL pipeline design, OLAP cubes, multidimensional modeling, data marts, BI platform integration' },
        ...
        { subs: [
          { name: 'Architectures de Modélisation Objet', topics: 'Model-Driven Architecture (MDA), meta-models, UML profiles, model transformations, platform-independent modeling' },
          { name: 'Plateformes de Développement', topics: 'Development frameworks, build tools, project scaffolding, modern toolchains' },
        ...
        { subs: [
          { name: 'Gestion de Projet Informatique', topics: 'Project planning (WBS, Gantt), risk management, cost estimation, stakeholder management, PMBOK essentials' },
          { name: 'Processus Agiles de Développement', topics: 'Scrum framework, Kanban, sprint planning, user stories, retrospectives, agile metrics, hybrid approaches' },
        ]},
        { subs: [
          { name: 'Réseaux Mobiles', topics: 'Mobile network architectures, cellular technologies (3G/4G/5G), mobile protocols, IoT connectivity' },
          { name: 'Développement des Applications Mobiles', topics: 'Android/iOS development, mobile UI design, responsive layouts, native vs. cross-platform frameworks' },
        ]},
      ],
    },
    s5: {
      ...
      modules: [
        { subs: [
          { name: 'Intégration des Services et des Objets', topics: 'SOA architecture, web services (SOAP/REST), API design, service orchestration, microservices integration, WSDL/UDDI' },
          { name: 'Intégration des Processus', topics: 'BPM, BPMN 2.0 modeling, process orchestration & choreography, workflow engines, process mining, enterprise process integration' },
          { name: 'Interface Homme/Machine', topics: 'HCI principles, user-centered design, usability evaluation methods, interaction paradigms, prototyping, user experience (UX) design, accessibility, cognitive load theory' },
        ]},
        { subs: [
          { name: 'Architecture à Base de Composants', topics: 'Component-based software engineering (CBSE), component models, interface contracts, component assembly, reusability patterns' },
          { name: 'Ingénierie Dirigée par les Modèles', topics: 'Model-Driven Engineering (MDE), meta-modeling (MOF, Ecore), model transformations (ATL, QVT), Domain-Specific Languages (DSLs), model validation & verification, MDA/MDD methodologies' },
          { name: 'Systèmes Multi-Agents Mobiles', topics: 'Multi-agent systems (MAS), agent architectures (BDI), agent communication (FIPA-ACL), distributed AI, agent-based modeling & simulation, mobile agents' },
        ]},
        { subs: [
          { name: "Architecture d'Entreprise", topics: 'TOGAF ADM cycle, Zachman framework, ArchiMate modeling, enterprise ontologies, meta-models for EA, architecture layers (business, data, application, technology), SOA/OASIS ontology' },
          { name: 'Audit, Urbanisation et Planification Stratégique des SI', topics: 'IS urbanization, strategic IS planning, IS audit methodologies, IT-business alignment, cartography of information systems, architecture governance' },
          { name: 'Développement des Stratégies Digitales', topics: 'Digital transformation strategy, technology roadmaps, innovation management, digital maturity assessment, platform economy' },
        ]},
        { subs: [
          { name: 'Référentiels et Bonnes Pratiques des SI', topics: 'ITIL v4, COBIT 2019, ISO 20000/27001, CMMI, service management, IT governance frameworks' },
          { name: 'Sécurité des SI', topics: 'Information security, risk assessment, cryptography, access control, security policies, penetration testing fundamentals' },
          { name: 'Intelligences et Aspects Avancés des SI', topics: 'AI-driven information systems, intelligent automation, advanced analytics for IS, smart decision support, AI integration in enterprise systems' },
        ]},
        { subs: [
          { name: 'Assurance Qualité des SI', topics: 'Quality management systems, ISO 9001, software quality metrics, SLA management, audit frameworks' },
          { name: 'Aspects Avancés de la Gestion de Projets SI', topics: 'Portfolio management, program management, advanced risk analysis, multi-project coordination, governance of IT projects' },
          { name: 'Organisation des DSI', topics: 'IT department organization, CIO roles, IT service management, IT sourcing strategies, digital governance structures' },
        ]},
        { subs: [
          { name: 'Conférences : IT et Entreprise', topics: 'Industry talks, technology trends, enterprise innovation case studies, guest lectures from industry professionals' },
          { name: 'Certification', topics: 'IBM AI Analyst certification preparation and examination' },
        ]},
        { subs: [{ name: 'Projet Fédérateur', topics: 'Capstone integrative project combining software engineering, IS governance, architecture, and quality — full lifecycle from requirements to deployment' }]},
        { subs: [{ name: 'TOEIC Preparation', topics: 'English proficiency, TOEIC exam preparation, professional English communication' }]},
      ],
    },
    projects: [
  ...
  fr: {
    ...
    s3: {
      ...
      modules: [
        { subs: [{ name: 'Génie Logiciel', topics: 'Cycle de vie du développement logiciel, ingénierie des exigences, UML, architecture logicielle, stratégies de tests, assurance qualité' }]},
        { subs: [{ name: 'Méthodologie de Développement des SI', topics: 'Méthodologies de développement des SI (Merise, UML), modélisation des processus métier, modélisation conceptuelle/logique/physique des données, architecture de données d\'entreprise' }]},
        { subs: [{ name: 'Modélisation Objet', topics: 'UML avancé (diagrammes de classes, séquence, activités, états), modélisation objet, design patterns, modélisation du domaine' }]},
        { subs: [{ name: 'Structuration & Échange de Données', topics: 'Standards XML/JSON, sérialisation de données, validation de schémas, échange de données structurées, formats de données des services web (SOAP, REST)' }]},
        { subs: [{ name: 'Programmation Objet Avancée', topics: 'Génériques, réflexion, annotations, design patterns avancés, frameworks, multithreading' }]},
        { subs: [
        ...
        { subs: [{ name: 'Réseaux TCP/IP / Technologies de Routage', topics: 'Pile TCP/IP, protocoles de routage (OSPF, BGP), sous-réseaux, VLANs, conception de réseaux' }]},
        { subs: [
    ...
    s5: {
      ...
      modules: [
        ...
        { subs: [{ name: 'Projet Fédérateur', topics: 'Projet intégrateur de synthèse combinant génie logiciel, gouvernance des SI, architecture et qualité — cycle de vie complet des exigences au déploiement' }]},
        { subs: [{ name: 'Préparation TOEIC', topics: 'Maîtrise de l\'anglais, préparation à l\'examen TOEIC, communication professionnelle en anglais' }]},
      ],
    },
    projects: [
      { description: 'Application web full-stack pour la supervision d\'équipements, le suivi des demandes de maintenance et le RBAC. Développée avec Spring Boot, Angular, authentification JWT et architecture MVC.' },
      { description: 'Système IA multi-agents pour la migration automatisée d\'applications Spring Boot monolithiques vers des microservices. 5 agents autonomes spécialisés (Architecte, Observateur, Stratège, Constructeur, Validateur), chacun alimenté par des LLMs dédiés.' },
      { description: 'Système en boucle fermée à double modèle : Modèle A (CatBoost) pour la prédiction de la qualité du sommeil et Modèle B (LightGBM Ranker) pour l\'optimisation des politiques d\'intervention personnalisées. Stack de données moderne : React Native, FastAPI, dbt, PostgreSQL, Great Expectations.' },
      { description: 'Application web assistée par IA pour la gestion des relevés — extraction d\'exigences par IA, tableaux de bord statistiques, module de simulation ERP. 75 tests (45 backend, 30 frontend) avec Vitest.' },
      { description: 'Projet individuel : intégration de données géospatiales multi-sources (45 ans de relevés pluviométriques, Indice de Richesse Relative). Tableaux de bord interactifs avec cartes Leaflet. 4 modèles de séries temporelles comparés — Prophet a obtenu le meilleur MAE (8.41).' },
      { description: 'Rapport de recherche sur l\'architecture des pipelines RAG, analyse comparative vs. fine-tuning, analyse du marché de l\'écosystème RAG (LangChain, LlamaIndex, FAISS, Chroma, Pinecone). Revue systématique de la littérature (2022–2025).' },
    ],
    internships: [
