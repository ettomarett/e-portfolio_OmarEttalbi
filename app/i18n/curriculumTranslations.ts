...
export const semesterTranslations = {
  en: {
    ...
    projects: [
      ...
      { title: 'SI Relevés: AI-Assisted Statements Management Web App', description: 'AI-assisted web application for statements management — AI-driven requirements extraction, dashboards with statistics, ERP simulation module. 75 tests (45 backend, 30 frontend) with Vitest.', year: '2025–2026 · 3rd Year', team: 'Omar Ettalbi + 6 teammates · Supervisor: Ms. Z. Mcharfi' },
