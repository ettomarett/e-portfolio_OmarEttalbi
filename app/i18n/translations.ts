      ...
      certs: [
        {
          ...
          url: 'https://www.credly.com/badges/ca3397a0-ce39-4de5-861f-fed63860857c/public_url',
        },
        {
        ...
        },
        {
          ...
          issuer: 'DataCamp',
          year: '2025',
          badge: '/images/drl_datacamp_badge.png',
          pdf: '/images/DRL_datacamp_certificate.pdf',
          url: 'https://www.datacamp.com/completed/statement-of-accomplishment/course/7b79fbef5ba370a5b3702939f414e2d193c89edf',
        },
      ],
    },
    services: {
      ...
      items: [
        {
          ...
          period: 'Toulouse, France | 2025 – 2026 (ongoing)',
          type: 'Current',
          description: 'Digitalization of shop floor operational processes in the MRO (Maintenance, Repair & Overhaul) aviation sector using SAP technologies.',
          achievements: [
            'Digitalizing shop floor operational processes using SAP S/4HANA',
            'Building data processing pipelines and dashboards with SAP Datasphere and SAP Analytics Cloud',
            'Working within MRO (Maintenance, Repair & Overhaul) aviation workflows',
          ],
        },
        {
          title: 'DevOps Engineer Intern',
          company: 'RaiseUp Consulting',
          period: 'Casablanca, Morocco | May – Sep 2025',
          type: 'Finished',
          description: 'Deployed and operated a production platform for student lifecycle management, handling infrastructure, CI/CD, and application security.',
          achievements: [
            'Deployed and operated a Next.js 15 + PostgreSQL production platform (student lifecycle management) with Docker containerization and automated database migrations',
            'Built a Jenkins-based CI/CD pipeline; integrated Sonarqube and Trivy for automated code-quality and security scanning',
            'Implemented RBAC authentication and structured, audited workflows',
          ],
        },
        {
          title: 'Full Stack Developer Intern',
          company: 'RaiseUp Consulting',
          period: 'Casablanca, Morocco | May – Sep 2024',
          type: 'Previous',
          description: "Designed and developed the company's official production website end-to-end.",
          achievements: [
            "Built and shipped the company's production website end-to-end: 20+ reusable React components and responsive Next.js (SSR/SSG) layouts",
            "Owned the full UX/UI; site was adopted as the official production version and deployed to the company's domain",
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          company: 'Diehl Aviation',
          period: 'Toulouse, France | 2025 – 2026 (en cours)',
          type: 'Current',
          description: 'Digitalisation des processus opérationnels du shop floor dans le secteur MRO (Maintenance, Repair & Overhaul) aéronautique avec les technologies SAP.',
          achievements: [
            'Digitalisation des processus opérationnels du shop floor avec SAP S/4HANA',
            'Construction de pipelines de traitement de données et tableaux de bord avec SAP Datasphere et SAP Analytics Cloud',
            'Travail au sein des workflows MRO (Maintenance, Repair & Overhaul) aéronautiques',
          ],
        },
        {
          title: 'Stagiaire Ingénieur DevOps',
          company: 'RaiseUp Consulting',
          period: 'Casablanca, Maroc | Mai – Sep 2025',
          type: 'Finished',
          description: 'Déploiement et exploitation d\'une plateforme de production pour la gestion du cycle de vie étudiant, couvrant l\'infrastructure, CI/CD et la sécurité applicative.',
          achievements: [
            'Déploiement et exploitation d\'une plateforme Next.js 15 + PostgreSQL (gestion du cycle étudiant) avec conteneurisation Docker et migrations automatisées',
            'Construction d\'un pipeline CI/CD Jenkins ; intégration de Sonarqube et Trivy pour l\'analyse automatisée de qualité et sécurité du code',
            'Implémentation de l\'authentification RBAC et de workflows structurés et audités',
          ],
        },
        {
          title: 'Stagiaire Développeur Full Stack',
          company: 'RaiseUp Consulting',
          period: 'Casablanca, Maroc | Mai – Sep 2024',
          type: 'Previous',
          description: 'Conception et développement complet du site web officiel de production de l\'entreprise.',
          achievements: [
            'Construction et livraison du site web de production de bout en bout : 20+ composants React réutilisables et layouts Next.js (SSR/SSG) responsives',
            'Propriété complète de l\'UX/UI ; site adopté comme version de production officielle et déployé sur le domaine de l\'entreprise',
          ],
        },
      ],
    },
